...
\begin{itemize}
    \item A few learned prompt tokens on a frozen VLM match LoRA at 20,000x fewer parameters with no forgetting, and extend to real-world robot manipulation via a frozen vision-language-action policy (arXiv:2609.11310).
\end{itemize}
...
\item \textbf{G.R. Gare}, S. Li, H. Wang, C.D. Hernandez, W. Zhao, W.M. Pauli, J. Galeotti, D. Ramanan.\\
\emph{Your Model Already Knows, Don't Teach It, Learn to Ask It: Soft Prompting for Few-Shot Adaptation of Vision-Language Models.}\\
\textbf{arXiv preprint arXiv:2609.11310}, 2026.
\publink{https://arxiv.org/abs/2609.11310}{paper}
\divider
...
\textbf{eXCV Workshop at ECCV}, 2026. \textbf{(Spotlight Oral)}
...
\begin{itemize}
\item Guest Lecturer – 16-720 Computer Vision and 16-199 Robotics in the Real World (Fall 2026)
